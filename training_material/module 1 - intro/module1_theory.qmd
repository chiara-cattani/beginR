---
title: "Module 1 Theory — RStudio & Environment Setup"
format: html
editor: visual
---

# 🧠 Module 1 Theory --- RStudio & Environment Setup
...
- Set CRAN mirror: `Tools → Global Options → Packages`
- Configure appearance: `Tools → Global Options → Appearance`
- Set working directory preferences

------------------------------------------------------------------------

## ⚙️ 2. Setting Up nutriciaconfig

The `nutriciaconfig` package helps manage your R environment and working directories for clinical programming projects.

### Installation:
```r
# Install nutriciaconfig (replace with actual installation method)
install.packages("nutriciaconfig")  # if on CRAN
# or remotes::install_github("org/nutriciaconfig")  # if on GitHub
```
...
nutriciaconfig::setup_project("my_clinical_study")
...
## 📦 4. Essential Packages for Clinical Programming
...
✅ Install and configure R, RStudio, and nutriciaconfig  
✅ Navigate the RStudio interface efficiently  
✅ Load essential packages for clinical programming  
✅ Use GitHub Copilot to assist with R code development  
✅ Understand the basic R syntax and workflow  
...
2. **nutriciaconfig** helps manage your project setup and working directories  
